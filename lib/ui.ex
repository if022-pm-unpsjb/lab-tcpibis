defmodule Libremarket.Ui do
  ...
  def comprar(id_producto, forma_de_entrega, medio_de_pago) do
    :erpc.call(:"compras@compras", Libremarket.Compras.Server, :comprar, [id_producto, forma_de_entrega, medio_de_pago])
  end
